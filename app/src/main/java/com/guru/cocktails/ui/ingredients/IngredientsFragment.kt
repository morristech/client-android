...
import com.guru.cocktails.ui.ingredients.IngredientsContract.Presenter
import com.guru.cocktails.ui.ingredients.IngredientsViewState.*
...
class IngredientsFragment : BaseFragment(), IngredientsContract.View {
    ...
    private val adapter by lazyFast { IngredientsAdapter(this) }

    override var viewState: IngredientsViewState by Delegates.observable<IngredientsViewState>(Init(), { _, _, new -> processStateChange(new) })
    ...
    private fun onNewItem(data: ListBundle<IngredientThumb>) {
    ...
    companion object {
        ...
        fun newInstance(bundle: Bundle): IngredientsFragment {
            return IngredientsFragment().apply {
                arguments = bundle
            }
        }

        fun createBundle(type: Type): Bundle {
